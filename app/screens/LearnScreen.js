...
const LEARN_ITEMS = [
{
	title: 'Denúncia, Queixa e Notícia-crime',
...
{
	title: 'Ministério Público vs Defensoria Pública',
    ...
    return (
      <ScrollView style={styles.container}>
        <View style={styles.imageContainer}>
          <Text style={styles.title}>Aprenda a denunciar!</Text>
          <Text style={styles.subtitle}>Perguntas frequentes relevantes para ser tornar um bom cidadão vigilante.</Text>
          <Image 
            style={{ width: 240, height: 150, alignSelf: 'center' }}
            source={LEARN_IMG}
          />
        </View>
